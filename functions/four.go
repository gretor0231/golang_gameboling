...
//If wild cards are given, compute the possible highest ranking of the hand. Two different wild cards will be given at most.
//
//Belows are the correspoding relationship between each interger and poker card (for better reading, integers are shown in hexadecimal):
//
...
//
//1. Royal flush: A poker hand with the A, K, Q, J and 10 all in the same suit.
